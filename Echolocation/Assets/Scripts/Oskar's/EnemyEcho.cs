...
public class EnemyEcho : MonoBehaviour
{
    ...
    void Start()
    {
        currentGroundType = GetComponent<EnemyFootstep>().currentGroundType;
        enemy = GameObject.Find("Zombie");
        stepCount = enemy.GetComponent<EnemyAI>().steps;
    ...
    IEnumerator FadeLines()
    {
        ...
        Color iceColor = new Color(0, 63, 92);
        Color normalColor = new Color(99, 0, 0);
